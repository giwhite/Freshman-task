...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", default=1, type=int, help="use what generation version")

    parser.add_argument("--root_dir", default="../data/cnn_dailymail/", type=str, help="raw data file dir")
    parser.add_argument("--input_max_len", default=1024, type=int, help="the max input len of a doc")
    ...
    parser.add_argument("--learning_rate", default=1e-5, type=int, help="learning rate of the training prograss")
